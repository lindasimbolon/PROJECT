...
<!-- Header -->
<header id="head">
		<h4><center><u>SIPAS DISETUJUI</u></center></h4>
				<form action="sipas_selesai_simpan.sml" name="form1" method="post" id="form_combo">
				...
				<tr align="left" height="30">
					...
					<input type="hidden" name="kode" value="<?php echo $hasil['id_pas'];?>" readonly size="40">
				...
				<tr align="left" height="30">
					<td width="150"></td>
					<td><input type="submit" value="SELESAI SIPAS"></td>
				</tr>
				</table>
				</form>
