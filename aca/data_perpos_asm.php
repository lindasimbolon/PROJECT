...
<!-- Header -->
<header id="head">
		<h2><b>DATA PERSETUJUAN PROPOSAL ASM</b></h2>
		<table id="contoh">
			<thead >  
			...
			<tbody>
				...
				where a.id_cmr=b.id_cmr and c.id_tipe_program=a.id_tipe_program and d.id_ao=b.id_ao and persetujuan_asm is null order by a.id_proposal DESC ");
				...
				<tr height="30">
					...
					<td align="left">
					<?php echo substr($hasil1['nama_program'],0,20);?> <a href="detail_proposal_asm.sml?id=<?php echo $hasil1['id_proposal'];?>">[....]</a>
					</td>
					...
					<td align="center">
					<a href="detail_proposal_asm.sml?id=<?php echo $hasil1['id_proposal'];?>"><img src='images/detail.png' width='12px' title='detail'></a>&nbsp;
					<!--<a href="edit_proposal.sml?id=<?php echo $hasil1['id_proposal'];?>"><img src='images/ubah.png' width='12px' title='edit'></a>&nbsp;-->
					<a href="hapus_proposal.sml?id=<?php echo $hasil1['id_proposal'];?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><img src='images/hapus.png' width='12px' title='hapus'></a>
					</td>
				</tr>
				<?php } ?>
					</tbody>
