...
<h2><b>PROPOSAL DISETUJUI</b></h2>
<div style="font-size:10px;">
		<table id="contoh" style="border:1px solid black" class="datatable table table-striped table-bordered">
			<thead >  
			...
			<tbody>
				...
				$ao = $_SESSION['ao'];
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_proposal a, tabel_cmr b, tabel_ao d
				where a.id_cmr=b.id_cmr and  d.id_ao=b.id_ao and d.singkatan='$ao' and ((persetujuan_rpm='Disetujui' and ((jenis_proposal='LOKAL')or(jenis_proposal='PUSAT')or
				(jenis_proposal='LOKAL_RM')or(jenis_proposal='LOKAL_GMO')or(jenis_proposal='PAS_<25')or(jenis_proposal='PAS_25_50')or(jenis_proposal='PAS_>50')))or(persetujuan_rm='Disetujui')) 
				order by a.id_proposal DESC limit 600");
				while ($hasil1 = mysql_fetch_array($sql1)){
				$i++;
				?>
				<tr height="30" align="left">
					<td align="center"><?php echo $i;?></td>
					<td><?php echo $hasil1['nama_ao'];?></td>
					...
					($hasil1['jenis_proposal']=='LOKAL_DIREKSI')){echo "_lokal";}elseif($hasil1['jenis_proposal']=='PUSAT_KDM'){echo "_kdm";}else{echo "_baru";}?>.sml?id=<?php echo $hasil1['id_proposal'];?>">[...]</a>
					</td>
					...
					<td align="center" style="border-left:1px solid black">
						<?php 
						if($hasil1['jenis_proposal']<>"LOKAL_DIREKSI"){ ?>
						<img src="images/check.png" width="25px" height="25px">
						<?php } ?>
					</td>
					<td align="center" >
						<?php 
					...
					($hasil1['jenis_proposal']=='LOKAL_DIREKSI')){echo "_lokal";}elseif($hasil1['jenis_proposal']=='PUSAT_KDM'){echo "_kdm";}else{echo "_baru";}?>.sml?id=<?php echo $hasil1['id_proposal'];?>"><img src='images/detail.png' width='12px' title='detail'></a>&nbsp;
