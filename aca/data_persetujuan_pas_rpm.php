...
<header id="head">
		...
		<table id="contoh">
			...
			<tbody>
				...
				where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and validasi_spv='Valid' and validasi_aca='Valid' and persetujuan_asm='Disetujui' and persetujuan_rpm is NULL and status_pas='Pending' order by no_pas ASC ");
