...
<div style="font-size:10px;">
		<table id="contoh">
			...
			<tbody>
				...
				$ao = $_SESSION['ao'];
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_cmr a, tabel_ao b, tabel_pas c where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and b.singkatan='$ao' order by c.no_pas DESC ");
