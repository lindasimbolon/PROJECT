		...
		<form action=""  method="post" >
			...
			<table width="50%" align="center"><br>  
				...
				<tr align="left" height="80">
					<td></td>
					<td><input type="submit" name="simpan" value="Simpan">&nbsp;&nbsp; <a href="detail_proposal_asm.sml?id=<?php echo $id_proposal;?>"><img src="images/back.png" width="50px" height="28px"></a></td>
				</tr>
			</table>
		</form>
...
$sql = mysql_query ("UPDATE `sml_pas`.`tabel_proposal` SET `persetujuan_asm` = '$persetujuan', `keterangan_asm` = '$keterangan' WHERE `tabel_proposal`.`id_proposal` = '$id_proposal'");
	...
	location.href='data_perpos_asm.php'</script>";
	}else{
	echo "<script>alert('Data gagal disimpan, silakan ulangi proses..')
	location.href='persetujuan_proposal_asm.php?id=$id_proposal'</script>";
	}
}
?>
