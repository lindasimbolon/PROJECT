...
<div style="font-size:10px;">
	<!--	<p align="left"><a href="excel_pas_disetujui.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p> -->
		<table id="contoh">
				<thead >
				<tr bgcolor="#2e9fd2" align="center">
					...
					<th rowspan="2" style="border-left:1px solid black" width="5%">FILE BERKAS</th>
			...
			<tbody>
				...
				where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and status_pas ='Disetujui' and b.singkatan='$singkatan' order by no_pas DESC ");
				...
				<tr height="30">
					...
					<?php if($hasil['kategori']=="PUSAT"){?>
					<?php if ($hasil1['validasi_spv']=="Valid"){echo "<img src='images/check.png' width='25px' height='25px'>";}else{echo "<img src='images/minus.png' width='25px' height='25px'>";}?>
					<?php }?>
					</td>
				 	<td align="center">
					<?php if($hasil['kategori']=="PUSAT"){?>
					<?php echo tgl_indo($hasil1['tgl_validasi_spv']);?>
					<?php }?>
					</td>
					...
					<td align="center" style="border-left:1px solid black"><a href="lihat_file.sml?id=<?php echo $hasil1['id_pas'];?>">lihat File</a></td>
				</tr>
				<?php } ?>
