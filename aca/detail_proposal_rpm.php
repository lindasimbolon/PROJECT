...
<header id="head">
			...
			?>
				...
				<tr align="left">
					<td></td>
					<td><a href="data_perpos_asm.sml"><input type="submit" value="Kembali"></a> <a href="persetujuan_proposal_rpm.sml?id=<?php echo $tampil['id_proposal'];?>"><input type="submit" value="Persetujuan"></a></td>
				</tr>
				</div>
