...
<header id="head">
			...
			?>
				...
				<tr align="left">
					<td></td>
					<td><a href="data_perpos_spv.sml"><input type="submit" value="Kembali"></a> <a href="validasi_proposal_spv.sml?id=<?php echo $tampil['id_proposal'];?>"><input type="submit" value="Validasi Proposal"></a></td>
				</tr>
				</div>
