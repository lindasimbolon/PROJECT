...
<!--<p align="left"><a href="../administrator/excel_pdm_ao.php?ao=<?php echo $_SESSION[ao];?>" target="_blank"><img src="../administrator/images/excel.png" width="30"> Excport to Excel</a></p> -->
		<table id="contoh">
			...
			<tbody>
				...
				$sql1 = mysql_query ("SELECT b.no_pas, b.program, a.persetujuan_aca, a.tgl_persetujuan_aca, a.persetujuan_rpm, a.tgl_persetujuan_rpm,
				...
				a.persetujuan_finance ='Ditolak' or a.persetujuan_direksi ='Ditolak') and d.singkatan='$singkatan' order by id_pdm DESC");
