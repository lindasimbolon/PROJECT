		...
		<form action=""  method="post" >
			...
			<table width="50%" align="center"><br>  
				...
				<tr align="left" height="80">
					<td></td>
					<td><input type="submit" name="simpan" value="Simpan">&nbsp;&nbsp; <a href="detail_pas_rm.sml?id=<?php echo $id_pas;?>"><img src="images/back.png" width="50px" height="28px"></a></td>
				</tr>
			</table>
		</form>
...
$sql = mysql_query ("UPDATE `sml_pas`.`tabel_pas` SET `persetujuan_rm` = '$persetujuan', `keterangan_rm` = '$keterangan' WHERE `tabel_pas`.`id_pas` = '$id_pas'");
	...
	location.href='data_persetujuan_pas_rm.sml'</script>";
	}else{
