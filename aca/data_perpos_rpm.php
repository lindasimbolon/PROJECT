...
<header id="head">
		...
		<table id="contoh">
			...
			<tbody>
				...
				where a.id_cmr=b.id_cmr and c.id_tipe_program=a.id_tipe_program and d.id_ao=b.id_ao and persetujuan_rpm is null order by a.id_proposal DESC ");
				...
				<tr height="30">
					...
					<td align="left">
					<?php echo substr($hasil1['nama_program'],0,20);?> <a href="detail_proposal_rpm.sml?id=<?php echo $hasil1['id_proposal'];?>">[....]</a>
					</td>
					...
					<td align="center">
					<a href="detail_proposal_rpm.sml?id=<?php echo $hasil1['id_proposal'];?>"><img src='images/detail.png' width='12px' title='detail'></a>&nbsp;
