...
<div style="font-size:10px;">
		<table id="contoh">
			...
			<tbody>
				...
				$i=0;
				$ao = $_SESSION['ao'];
				$sql1 = mysql_query ("SELECT * FROM tabel_cmr a, tabel_ao b, tabel_pas c where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and b.singkatan='$ao' and 
				validasi_aca is null and status_pas='Pending' and kategori='LOKAL' order by no_pas ASC");
				...
				<tr height="30">
					...
					<td align="center">
					<a href="detail_pas_aca_lokal.sml?id=<?php echo $hasil1['id_pas'];?>"><img src='images/detail.png' width='12px' title='lihat'></a>
