...
<div style="font-size:10px;">
		<table id="contoh" class="datatable table table-striped">
			...
			<tbody>
				...
				b.id_ao=c.id_ao and (`persetujuan_asm` = 'Ditolak' or `persetujuan_rpm`='Ditolak' or `persetujuan_rma` = 'Ditolak' or `persetujuan_rm`='Ditolak') order by a.id_proposal DESC");
