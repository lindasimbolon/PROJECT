				...
				<tr>
					...
					?>
						...
						<tr>
							...
							<td>:</td>
							<td align="left"><?php if($hasil['akhir_pelaksanaan']<>"0000-00-00"){ ?> 
							...
							<td colspan="3">
								...
								<table width="70%" border="1" style="margin:10px 20px;">
									...
									<tr>
										...
										<td width="25%" align="center" class="td"><?php if($hasil['akhir_pelaksanaan']<>"0000-00-00"){ ?> <?php echo tgl_indo($hasil['mulai_pelaksanaan']);?> s/d 
								...
								<table width="80%" border="1" style="margin:0px 200px;">
									
									
									<tr align="center" height="30">
										<td width="5%" class="td"><b>NO</b></td>
										<td width="25%" class="td"><b>ITEMS</b></td>
										<td width="15%" class="td"><b>KOTA</b></td>
										<td width="5%" class="td"><b>JUMLAH</b></td>
										<td width="13%" class="td"><b>HARGA/UNIT</b></td>
										<td width="10%" class="td"><b>HARI KERJA</b></td>
										<td width="17%" class="td"><b>TOTAL (Rp.)</b></td>
									...
									<td align="left" colspan='2'>:
										<table width="70%" border="1">
											...
											<tr>
												...
												<td align="right" class="td"><b><?php if($jumlah2>=1){echo number_format($jumlah2);}?></b></td>
											</tr>
										</table>
									</td>
								</tr>
