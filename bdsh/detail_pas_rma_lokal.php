		...
		<h4><center><u>REVIEW PAS</u></center></h4>
				...
				<br>
						...
						<tr>
									<td></td>
									<td></td>
									<td align="left"><a href='javascript:history.back()'><input type="submit" value="Kembali"></a> <a href='persetujuan_pas_rma.sml?id=<?php echo $hasil[id_pas];?>'><input type="submit" value="Validasi"></a></td>
								</tr>
						</table>
					</td>
				</tr>
