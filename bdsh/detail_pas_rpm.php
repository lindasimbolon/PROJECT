					...
					?>
						...
						<tr style="border:1px solid silver;">
							<td colspan="3">
								...
								<table width="100%">
								<tr>
									<td width="15%" align="left" valign="top">9. Penanggung Jawab</td>
									<td width="1%" align="left" valign="top">:</td>
									<td width="15%" align="left"><input type="checkbox" name="penanggung_jawab[]" value="Promotion Team PT SML" <?php if (in_array("Promotion Team PT SML", $pj)){echo "Checked";}?> disabled/> Promotion Team PT SML</td>
