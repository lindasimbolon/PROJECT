			...
			?>
				...
				<p><strong>III. RINCIAN BUDGET</strong></p>
					...
					<tr align="center">
						...
						<td width="15%"><b>Item Non PPh</b></td>
						<td width="15%"><b>Item Unsur PPh</b></td>
				...
				<tr align="left">
					<td></td>
					<td><a href="javascript:history.back()"><input type="submit" value="Kembali"></a> <a href="persetujuan_proposal_rpm.sml?id=<?php echo $tampil['id_proposal'];?>"><input type="submit" value="Persetujuan"></a></td>
				</tr>
				</div>
