...
<header id="head">
		<h4><center><u>REVIEW PAS LOKAL</u></center></h4>
				...
				<form action="ajukan_pas.sml" method="GET">
				...
				<tr>
					...
					<?php 
					$id 	= $_GET['id'];
					$sql 	= mysql_query("SELECT * FROM tabel_proposal a, tabel_tipe_program b, tabel_jenis_program c where a.id_tipe_program=b.id_tipe_program and b.id_jenis_program=c.id_jenis_program 
					and a.id_proposal='$id'");
					...
					?>
						...
						<tr height="10">
							<td width="12%" align="left"><b>Nomor Pas</b></td>
							<td width="1%">:</td>
							<td width="70%" align="left"><i><font size="2px" style="color:green;">nomor PAS otomatis tersimpan..</font></i></td>
						</tr>
						<tr>
							<td width="150"  align="left"><b>Agent</b></td>
							<td>:</td>
							<td  align="left">PT. SML</td>
						</tr>
						<tr>
							<td align="left"><b>Ditunjukan Kepada</b></td>
							<td>:</td>
							<td align="left">Exclusive Agent Manager</td>
						</tr>
						<tr>
						...
						<tr style="border:1px solid silver;">
							<td colspan="3">
								...
								<tr>
									<td></td>
									<td></td>
									<td align="left"><input type="submit" value="Ajukan PAS"></td>
								</tr>
								<tr>
									<td><br></td>
								</tr>
