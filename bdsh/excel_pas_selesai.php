...
header("Content-Disposition: attachment; filename=pas_selesai.xls");
include "../koneksi.php";
?>
		...
		<table border="1" width="100%">
			<tr bgcolor="#2e9fd2" align="center" height="40">
				...
				where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and status_pas ='Selesai' order by no_pas ASC ");
				...
				<?php } ?>
				<?php
				$sql = mysql_query ("SELECT sum(total_pas) as total from tabel_pas where status_pas='Selesai'");
