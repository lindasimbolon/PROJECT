...
<header id="head">
	...
	<h3>DATA PENGEMBALIAN SISA PDM</h3>
		<table style="color:black;" id="contoh"><br>
			<thead >  
			...
			<tbody>
				...
				$i=0;
				//$ao = $_SESSION['ao'];
				$sql1 = mysql_query ("SELECT * FROM tabel_pengembalian a, tabel_sipas b, tabel_pas c where a.id_sipas=b.id_sipas and b.id_pas=c.id_pas");
				...
				<tr height="30">
					...
					<td align="center"  style="border-left:1px black solid;"><a href="../administrator/file/<?php echo $hasil1['file'];?>" target="_blank">Lihat</a></td>
