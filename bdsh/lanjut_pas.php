...
<header id="head">
		<h4><center><u>INPUT ESTIMASI PAS</u></center></h4>
				<form action="lanjut_pas_simpan.sml" name="form1" method="post" id="form_combo">
				<table width="50%"><br>  
				<?php
				$id = $_GET['id'];
				...
				<p align="left" height="30"><a href="selesai.sml"><img src="images/back.jpg" width="50"> Selesai</a></p>
