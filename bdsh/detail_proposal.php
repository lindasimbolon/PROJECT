...
<header id="head">
			...
			?>
				...
				<p align="left">&nbsp;&nbsp;<?php if($tampil['file1']<>""){ echo "<a href='../cmr/upload/$tampil[file1]' target='_blank'>Lifat File..</a>";}else{echo "Tidak Ada File";}?></p><br>
				
				
				<tr align="left">
					<td></td>
					<td><a href="javascript:history.back()"><input type="submit" value="Kembali"></a>  <?php if($tampil['persetujuan_rpm']=="Disetujui"){?><button style="margin-left:5%" onClick="print_d()">Print Document</button><?php } ?></td>
				</tr>
				</div>
				 ...
				 <script>
				 function print_d(){
				   	window.open("print_proposal.php?id=<?php echo $id_proposal;?>","_blank");
				 }
				 </script>
