...
<!--<p align="left"><a href="../administrator/excel_pdm_ao.php?ao=<?php echo $_SESSION[ao];?>" target="_blank"><img src="../administrator/images/excel.png" width="30"> Excport to Excel</a></p> -->
		<table id="contoh">
			...
			<tbody>
				...
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_pdm a, tabel_pas b, tabel_cmr c, tabel_ao d, tabel_user e where d.regional=e.regional and e.regional='".$regional."' and a.id_pas=b.id_pas and b.id_cmr=c.id_cmr and 
				c.id_ao=d.id_ao and a.persetujuan_aca='Disetujui' and a.persetujuan_rpm is null and status_pdm='Pending' order by id_pdm DESC");
