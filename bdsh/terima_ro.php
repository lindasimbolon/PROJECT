...
<!-- Header -->
<header id="head">
		<h4><center><u>TERIMA SIPAS DARI AO</u></center></h4>
				<form action="terima_ro_simpan.sml" name="form1" method="post" id="form_combo">
				...
				<tr align="left" height="30">
					<td>TGL TERIMA SIPAS</td>
					<td><input type="text" name="tgl" id="brothergiez" required></td>
				</tr>
				<tr align="left" height="30">
					<td width="150"></td>
					<td><input type="submit" value="Terima SIPAS"></td>
				</tr>
				</table>
				</form>
