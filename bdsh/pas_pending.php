...
<h3><b>PAS PENDING/ STATUS</b></h3>
<!-- <p align="left"><a href="excel_pas_pending.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p> -->
<div style="font-size:10px;">
		<table style="color:black;" id="contoh" class="datatable table table-striped">
				<thead >
				<tr bgcolor="#2e9fd2" style="color:white;" align="center">
					...
					<th colspan="10" style="border-left:1px solid black">REVIEW</th>
				...
				<tr bgcolor="#2e9fd2" style="color:white;" align="center">
					...
					<th width="4%">TANGGAL</th>
					<th width="3%" style="border-left:1px solid black">BD SH</th>
					<th width="4%">TANGGAL</th>
			...
			<tbody>
				<?php
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_ms a, tabel_area b, tabel_pas c where a.id_ms=c.id_ms and a.id_area=b.id_area order by c.id_pas DESC ");
				...
				<tr height="30">
					...
					<td align="center" style="border-left:1px solid black">
						<?php 
						if((($hasil1['kategori']<>"PAS_<25")or($hasil1['kategori']<>"PAS_25_50")or($hasil1['kategori']<>"PAS_>50")) and ($hasil1['tgl_pengajuan']>='2017-03-27')){
							if ($hasil1['persetujuan_bdsh']==""){
								echo "<img src='images/minus.png' width='25px' height='25px'>";
							}elseif($hasil1['persetujuan_bdsh']=="Disetujui"){
								echo "<img src='images/check.png' width='25px' height='25px'>";
							}elseif($hasil1['persetujuan_bdsh']=="Direvisi"){
								echo "<img src='images/revisi.gif' width='25px' height='25px'>";
							}else{
								echo "<img src='images/cross.png' width='25px' height='25px'>";
							}
					...
					<td>
						<?php 
						if((($hasil1['kategori']<>"PAS_<25")or($hasil1['kategori']<>"PAS_25_50")or($hasil1['kategori']<>"PAS_>50")) and ($hasil1['tgl_pengajuan']>='2017-03-27')){
							echo tgl_indo($hasil1['tgl_persetujuan_bdsh']);
						}
						?>
					</td>
					<td align="center" style="border-left:1px solid black">
					...
					<td align="center" style="border-left:1px solid black">
						<?php 
						//if(($hasil1['kategori']=="LOKAL_GMO")or($hasil1['kategori']=="LOKAL_DIREKSI")){
