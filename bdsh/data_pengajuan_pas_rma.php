...
<header id="head">
		...
		<table id="contoh">
			...
			<tbody>
				...
				where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and validasi_spv='Valid' and validasi_aca='Valid' and persetujuan_asm='Disetujui' and persetujuan_rpm='Disetujui' and persetujuan_rm='Disetujui' and status_pas='Pending' order by no_pas ASC ");
				...
				<tr height="30">
					...
					<td align="center">
					<a href="detail_pas_pengajuan.sml?id=<?php echo $hasil1['id_pas'];?>"><img src='images/detail.png' width='12px' title='lihat'></a>
