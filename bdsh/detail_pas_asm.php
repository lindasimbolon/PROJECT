						...
						<tr style="border:1px solid silver;">
							<td colspan="3">
								...
								<tr>
									<td></td>
									<td></td>
									<td align="left"><a href='data_persetujuan_pas_asm.sml'><input type="submit" value="Kembali"></a> <a href='persetujuan_pas_asm.sml?id=<?php echo $hasil[id_pas];?>'><input type="submit" value="Persetujuan"></a></td>
								</tr>
								<tr>
									<td><br></td>
								</tr>
