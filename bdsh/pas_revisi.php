		...
		<table id="contoh" style="color:black;" class="datatable table table-striped">
			...
			<tbody>
				...
				$sql1 = mysql_query ("SELECT * FROM tabel_ms a, tabel_area b, tabel_pas c
						where a.id_ms=c.id_ms and a.id_area=b.id_area and status_pas ='Direvisi' order by c.no_pas ASC ");
				...
				<tr height="30">
					...
					<td align="center" style="border-left:1px solid black">
						...
						if((($hasil1['kategori']<>"PAS_<25")or($hasil1['kategori']<>"PAS_25_50")or($hasil1['kategori']<>"PAS_>50")) and ($hasil1['tgl_pengajuan']>='2017-03-27')){
							if ($hasil1['persetujuan_rm']==""){
								...
								echo "<img src='images/revisi.png' width='25px' height='25px'>";
							}
						}
						?>
					</td>
					...
					<td align="center">
						<?php 
							echo tgl_indo($hasil1['tgl_persetujuan_bdm']);
						?>
					</td>
