						...
						<tr style="border:1px solid silver;">
							<td colspan="3">
								...
								<tr>
									<td></td>
									<td></td>
									<td align="left"><a href='data_validasi_pas_aca.sml'><input type="submit" value="Kembali"></a> <a href='validasi_pas_aca.sml?id=<?php echo $hasil[id_pas];?>'><input type="submit" value="Validasi"></a></td>
								</tr>
								<tr>
									<td><br></td>
								</tr>
