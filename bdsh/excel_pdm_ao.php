...
header("Content-Disposition: attachment; filename=pdm_ao.xls");
include "../koneksi.php";
?>
		...
		<table border="1" width="100%">
			<tr bgcolor="#2e9fd2" align="center" height="40">
				...
				$ao = $_GET['ao'];
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_pdm a, tabel_pas b, tabel_cmr c, tabel_ao d where a.id_pas=b.id_pas and b.id_cmr=c.id_cmr and c.id_ao=d.id_ao and status_pdm='Disetujui' and d.singkatan='$ao'");
