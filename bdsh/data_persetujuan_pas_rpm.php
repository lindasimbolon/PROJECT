...
<div style="font-size:10px;">		
		<table id="contoh">
			...
			<tbody>
				...
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_cmr a, tabel_ao b, tabel_pas c, tabel_user d where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and validasi_aca='Valid' 
				and persetujuan_asm='Disetujui' and persetujuan_rpm is NULL and status_pas='Pending' and d.regional=b.regional and d.regional='".$regional."' order by no_pas ASC ");
				...
				<tr height="30">
					...
					<td align="center">
					<a href="detail_pas_rpm.sml?id=<?php echo $hasil1['id_pas'];?>"><img src='images/detail.png' width='12px' title='lihat'></a>
