...
<div style="font-size:10px;">
		<table id="contoh" style="border:1px solid black" class="datatable table table-striped table-bordered">
			...
			<tbody>
				...
				where a.id_cmr=b.id_cmr and  d.id_ao=b.id_ao and ((persetujuan_rpm='Disetujui' and ((jenis_proposal='LOKAL')or(jenis_proposal='PUSAT')or
				(jenis_proposal='LOKAL_RM')or(jenis_proposal='LOKAL_GMO')or(jenis_proposal='PAS_<25')or(jenis_proposal='PAS_25_50')or(jenis_proposal='PAS_>50')))or
				(persetujuan_rm='Disetujui')) order by a.id_proposal DESC ");
