		...
		<form action="data_proposal.sml" method="POST">
			<table width="100%" align="center" style="border:1px solid black;">
				...
				<tr>
					...
					$id 	= $_GET['id'];
					$sql 	= mysql_query("SELECT a.mulai_pelaksanaan, a.akhir_pelaksanaan, a.id_proposal, d.no_pas, f.nama_ao, a.brand, a.nama_program,c.jenis_program, a.lokasi_territory,
										   a.lokasi_kecamatan, a.lokasi, a.latar_belakang, a.tujuan_sasaran, a.mekanisme_pelaksanaan, a.target_audience, a.target_contact, d.tgl_persetujuan_asm,
										   d.tgl_persetujuan_rm, f.singkatan, f.asm, f.nama_rpm, e.nama_cmr, a.penanggung_jawab FROM tabel_pas d, tabel_proposal a, tabel_tipe_program b, tabel_jenis_program c, tabel_cmr e,
					...
					$tanggal1	= $hasil['mulai_pelaksanaan'];
					...
					?>
						...
						if(($pilihan=="EVENT")or($pilihan=="SPONSORSHIP")or($pilihan=="CONSUMER PROMO")){
						$pilih = "EVENT";
