...
<!-- Header -->
<header id="head">
		<h4><center><u>REVIEW PAS LOKAL</u></center></h4>
				...
				<tr>
					<td>
						...
						<tr height="10">
							...
							<td width="1%">:</td>
							<td width="70%" align="left"><i><font size="2px" style="color:green;">nomor PAS otomatis didapat setelah PAS berhasil diajukan..</font></i></td>
						</tr>
						<tr>
						...
						<tr height="30">
							...
							<td>:</td>
							<td align="left">Week&nbsp;&nbsp; &nbsp;: <?php if($hasil['akhir_pelaksanaan']==""){echo $week;} else {echo $week.'s/d'.$week1;}?>
							</td>
						</tr>
						<tr height="30">
							<td align="left"></td>
							...
							<td colspan="3">
								...
								<tr>
									...
									<td align="left" colspan='2'>:
										...
										<tr align="center">
											<td rowspan="2" width="15%"><b>Brand</b></td>
											<td rowspan="2" width="10%"><b>Outlet Universe</b></td>
											<td colspan="2" width="10%"><b>Outlet Terdistribusi</b></td>
											<td rowspan="2" width="10%"><b>Target Distribusi (%)</b></td>
										</tr>
										<tr  align="center">
											<td width="10%"><b>( % )</b></td>
								...
								<tr>
									<td></td>
									<td></td>
									<td align="left"><a href="ajukan_pas.sml?id=<?php echo $hasil['id_proposal'];?>"><input type="submit" value="Ajukan PAS"></a> &nbsp;<a href="javascript:history.back()"><input type="submit" value="Kembali"></a></td>
								</tr>
								<tr>
									<td><br></td>
								</tr>
