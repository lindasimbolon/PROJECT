		...
		<h4><center><u>REVIEW PAS</u></center></h4>
				...
				<tr>
					...
					$sql 	= mysql_query("SELECT * FROM tabel_pas d, tabel_proposal a, tabel_tipe_program b, tabel_jenis_program c where d.id_proposal=a.id_proposal and 
											((a.id_tipe_program=b.id_tipe_program and b.id_jenis_program=c.id_jenis_program) or (a.id_jenis_program=c.id_jenis_program))
						               and d.id_pas='$id'");
					...
					?>
						...
						<tr height="10">
							...
							<td width="1%">:</td>
							<td width="70%" align="left"><i><font size="2px" style="color:green;">nomor PAS otomatis didapat setelah PAS disetujui oleh Regional Manager..</font></i></td>
						</tr>
						<tr>
				...
				<br>
						...
						<tr>
									<td></td>
									<td></td>
									<td align="left"><a href='javascript:history.back()'><input type="submit" value="Kembali"></a> <a href='persetujuan_pas_rpm.sml?id=<?php echo $hasil[id_pas];?>'><input type="submit" value="Persetujuan"></a></td>
								</tr>
						</table>
					</td>
				</tr>
