...
<div style="font-family:calibri;">
			...
			?>
				...
				<tr align="left">
					<td></td>
					<td><a href="javascript:history.back()"><input type="submit" value="Kembali"></a> <a href="persetujuan_proposal_rma.sml?id=<?php echo $tampil['id_proposal'];?>"><input type="submit" value="Verifikasi"></a></td>
				</tr>
				</div>
