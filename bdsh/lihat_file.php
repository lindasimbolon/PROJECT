		...
		<table id="contoh"><br>
			...
			<!--
				<tr height="30">
					...
					<td align="center"><a href="detail_proposal<?php if(($hasil['kategori']=="LOKAL")or($hasil['kategori']=="LOKAL_RM")or($hasil['kategori']=="LOKAL_GMO")or($hasil['kategori']=="LOKAL_DIREKSI")){echo "_lokal";}elseif($hasil['kategori']=="PUSAT_KDM"){echo "_kdm";}?>.sml?id=<?php echo $hasil['id_proposal'];?>">Lihat</a></td>
			...
			-->
				<tr height="30">
					...
					<td align="center"><a href="detail_pas_pengajuan<?php if(($hasil['kategori']=="LOKAL")or($hasil['kategori']=="LOKAL_RM")or($hasil['kategori']=="LOKAL_GMO")or($hasil['kategori']=="LOKAL_DIREKSI")){echo "_lokal";}?>.sml?id=<?php echo $hasil['id_pas'];?>">Lihat</a></td>
