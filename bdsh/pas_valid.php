	...
	<!--	<p align="left"><a href="excel_pas_disetujui.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p> -->
		<table style="color:black;" id="contoh" class="datatable table table-striped">
			...
			<tbody>
				<?php
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_ms a, tabel_area b, tabel_pas c
				where a.id_ms=c.id_ms and a.id_area=b.id_area and status_pas ='Disetujui' order by no_pas DESC");
