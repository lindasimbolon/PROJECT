...
<h2><b>PROPOSAL PENDING/ STATUS</b></h2>
<div style="font-size:10px;">
		<table id="contoh" style="border:1px solid black" class="datatable table table-striped">
			<thead >
			...
			<tbody>
				<?php
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM `tabel_proposal` a, tabel_cmr b, tabel_ao c WHERE a.id_cmr=b.id_cmr
				and b.id_ao=c.id_ao order by a.id_proposal DESC limit 600");
