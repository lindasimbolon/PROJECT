...
<header id="head">
		...
		<table id="contoh">
			...
			<tbody>
				...
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_cmr a, tabel_ao b, tabel_pas c where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and (persetujuan_asm='Disetujui' and 
				persetujuan_rpm='Disetujui' and persetujuan_rm='Disetujui' and status_pas='Pending' and (c.kategori='PAS_<25' or c.kategori='PAS_25_50' or c.kategori='PAS_>50')) order by no_pas DESC ");
				...
				<tr height="30">
					...
					<td align="center">
					<a href="detail_pas_pengajuan_baru.sml?id=<?php echo $hasil1['id_pas'];?>"><img src='images/detail.png' width='12px' title='lihat'></a>
					</td>
				</tr>
				<?php } ?>
