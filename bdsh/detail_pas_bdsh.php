...
<header id="head">
		<h4><center><u>REVIEW PAS</u></center></h4>
				...
				<tr>
					...
					<?php 
					$id 	= $_GET['id'];
					$sql 	= mysql_query("SELECT * FROM tabel_proposal a, tabel_tipe_program b, tabel_jenis_program c, tabel_pas d, tabel_ms e, tabel_area f, tabel_estimasi_budget g where d.id_proposal=a.id_proposal and ((a.id_tipe_program=b.id_tipe_program and b.id_jenis_program=c.id_jenis_program) or (a.id_jenis_program=c.id_jenis_program)) and d.id_pas='$id' and d.id_ms=e.id_ms and d.id_ms=f.id_ms and a.id_proposal=g.id_proposal");
					...
					?>
						...
						<tr height="10">
							<td width="12%" align="left">Pilar</td>
							<td width="1%">:</td>
						...
						<tr height="30">
							<td colspan="3">
								...
								<tr>
									<td align="left" valign="top"><b>9. Target Sales</b></td>
									<td align="left" colspan='2'>:
								...
								<tr>
									<td><b>10. Lampiran</b></td>
									<td><b><a style="color:white;" class="btn btn-success" href="../ms/upload/<?php echo $hasil['file1'];?>"target="_blank"><i class="fa fa-download" aria-hidden="true"> Lihat File...</i></a></b></td>
								</tr>
								<tr>
									<td><br></td>
								</tr>
						...
						<tr>
							...
							<td width="1%"  align="left"></td>
							<td align="left" style="color:black;"><b><h4><u>Plan Permintaan Dana Marketing	</u></h4></b></td>
						</tr>
						</table>
				...
				<br>
						...
						<tr>
								<td></td>
								<td></td>
								<td align="left"><a href='javascript:history.back()'><input type="submit" value="Kembali"></a> <a href='persetujuan_pas_bdsh.sml?id=<?php echo $hasil[id_pas];?>&id_proposal=<?php echo $hasil[id_proposal];?>'><input type="submit" value="Persetujuan"></a></td>
						</tr>
						</table>
					</td>
				</tr>
