...
<!--<p align="left"><a href="excel_sipas_kao.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p>-->
		<table style="color:black;" id="contoh" class="datatable table table-striped table-bordered">
			...
			<tbody>
				...
				$sql1 = mysql_query ("SELECT * FROM tabel_sipas a, tabel_pas b, tabel_ms c, tabel_area d
							WHERE b.id_ms=c.id_ms AND c.id_area=d.id_area AND a.id_pas=b.id_pas AND a.status_sipas='Pending'");
				//$sql1 = mysql_query ("SELECT * from tabel_sipas a, tabel_pas b where a.id_pas=b.id_pas and a.tgl_kirimao<>'' and a.status_sipas='Pending'");
				...
				<tr height="30">
					...
					//$sisa = $pdm['total_pdm']-$hasil_sipas['total'];
