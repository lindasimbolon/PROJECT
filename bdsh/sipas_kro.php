...
<!--<p align="left"><a href="excel_sipas_kro.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p>-->
		<table style="color:black;" id="contoh" class="datatable table table-striped table-bordered">
				...
				<tr bgcolor="#2e9fd2" align="center">
					...
					<th width="16%">TGL KIRIM KE HO</th>
			...
			<tbody>
				...
				$sql1 = mysql_query ("SELECT * FROM tabel_sipas a, tabel_pas b, tabel_ms c, tabel_area d
							WHERE b.id_ms=c.id_ms AND c.id_area=d.id_area AND a.id_pas=b.id_pas AND a.status_sipas='Pending kirim'");
				...
				<tr height="30">
					...
					<td align="center"><a href="sipas_selesai.sml?id=<?php echo $hasil1['id_sipas'];?>">Belum Terima</a></td>
