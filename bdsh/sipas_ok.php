...
<!--<p align="left"><a href="excel_sipas_ok.php" target="_blank"><img src="images/excel.png" width="30"> Export to Excel</a></p>-->
		<table style="color:black;" id="contoh" class="datatable table table-striped table-bordered">
			...
			<tbody>
				...
				$i=0;
				$sql1 = mysql_query ("SELECT * from tabel_sipas a, tabel_pas b, tabel_ms c, tabel_area d where  a.id_pas=b.id_pas and tgl_terimasipas<>'' and status_sipas='Selesai'
				and b.id_ms=c.id_ms and c.id_area=d.id_area");
