...
<div style="font-size:10px;">		
		<table id="contoh">
			...
			<tbody>
				...
				$i=0;
				$sql1 = mysql_query ("SELECT * FROM tabel_cmr a, tabel_ao b, tabel_pas c, tabel_user d where a.id_cmr=c.id_cmr and a.id_ao=b.id_ao and persetujuan_asm='Disetujui' 
				and persetujuan_rpm is NULL and status_pas='Pending' and d.regional=b.regional and d.regional='".$regional."' and (c.kategori='PAS_<25' or c.kategori='PAS_25_50' or c.kategori='PAS_>50')
				order by no_pas DESC");
				...
				<tr height="30">
					...
					<td align="center">
					<a href="detail_pas_rpm_lokal.sml?id=<?php echo $hasil1['id_pas'];?>"><img src='images/detail.png' width='12px' title='lihat'></a>
